...
cd /shared/network/
git clone https://github.com/blogsdon/brainRegNetwork.git
...
echo "https://github.com/blogsdon/brainRegNetwork/blob/master/getData.R,TRUE" >> /shared/network/provenanceFile.txt
