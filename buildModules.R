...
obj = synapseClient::File(paste0(bicNet.id,'/',module.method,'.',runId,'.modules.tsv'), parentId = fold$properties$id)
...
obj.qc = synapseClient::File(paste0(bicNet.id,'/',module.method,'.',runId,'.moduleQCMetrics.tsv'), parentId = fold$properties$id)
